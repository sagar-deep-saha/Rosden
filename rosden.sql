...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 06, 2024 at 10:35 AM
...
CREATE TABLE `details` (
  `id` int(11) NOT NULL,
  `roll` varchar(66) NOT NULL,
  `name` varchar(66) NOT NULL,
  `phone` varchar(66) NOT NULL,
  `email` varchar(66) NOT NULL,
  `addr` varchar(966) NOT NULL,
...
(1, '899', 'Ashwin', '234567890', 'emi@emi.ccom', 'Address Fork', '2024-04-06 14:04:51');
...
(16, '2366', '$2y$10$TgeVRFtxAAy6OIh/eF9mteLJWBo/fF.3iJlza/rI2x.LFM2w5c9Rq', '', '', '', '', '2024-04-06 14:01:35'),
(17, '2355', '$2y$10$ZWHML0gjljsfD./IVbR0aO5HAW38l2nRoKs0im/bSTiwAVUROBWFi', '', '', '', '', '2024-04-06 14:02:04'),
(18, '899', '$2y$10$K126rWW9Aq2uQxU5/OxzaucUiQjYf0oJqP2R9cG0wRKzgs5kZqxRe', '', '', '', '', '2024-04-06 14:04:51');
...
--
ALTER TABLE `users`
  MODIFY `userid` int(60) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
