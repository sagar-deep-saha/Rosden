...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    if($password == $cpassword){
        ...
        $sql_query = "INSERT INTO `users`(`roll`,`pass`) VALUES ('$username','$hash')";
...
<body>
    ...
    <div class="box0">
            <form action="" method="post" id="reg_form">
                ...
                <input type="text" name="roll" id="reg_roll"><br><br>
                ...
                <input type="password" name="pass" id="reg_pass"><br><br>
                <label for="cpass">Confirm Password</label><br>
                <input type="password" name="cpass" id="reg_cpass"><br><br>
                <br>
